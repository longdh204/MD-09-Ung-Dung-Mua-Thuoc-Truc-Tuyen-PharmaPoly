...
public class User implements Serializable {
    ...
    public User(String _id, String full_name, Date date_of_birth, int gender, String phone_number, String shipping_phone_number, String google_id, String avatar_url, String uid, int role, int status) {
        this._id = _id;
        this.full_name = full_name;
